...
class GameView:
    ...
    def display(self, board, put_positions):
        ...
        for i, player in enumerate(board.players):
            ...
            scr.addstr(9 + i, 0, f'{player.name} {teban_str}')
        x, y = put_positions[0]
        scr.addstr(11, 0, '[Space] Next piece. [Return] Put piece. [q] Quit.')
    ...
    def write_message(self, message):
        scr = self.strscr
        scr.addstr(9, 0, message)
        scr.addstr(10, 0, "                   ")
        scr.addstr(11, 0, '[Space] Play again. [q] Quit.                    ')
        scr.refresh()
